    ...
    <div class='w3eden' id='wpdmreg'>
        ...
        <?php } ?>
            ...
            <div class="panel-body" -->
                ...
                <div class="form-group"><button type="submit" class="btn btn-success btn-lg btn-block" id="registerform-submit" name="wp-submit"><i class="fa fa-user-plus"></i> &nbsp;<?php _e('Join Now!','download-manager'); ?></button></div>

                <?php if($loginurl != ''){ ?>
                    <div class="text-center"><?php _e('Already have an account?', 'download-manager'); ?> <a class="color-purple" href="<?php echo $loginurl;?>" id="registerform-submit" name="wp-submit"><strong><?php _e('Log In','download-manager'); ?>.</strong></a></div>
                <?php } ?>
