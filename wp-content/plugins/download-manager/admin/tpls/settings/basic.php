                ...
                <div class="panel-body">
                    ...
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <li><label><input <?php if(in_array('google-font', $wpdmss)) echo 'checked=checked'; ?> type="checkbox" value="google-font" name="__wpdm_disable_scripts[]"> <?php _e("Google Font","wpdmpro"); ?></label></li>
                        </ul>
